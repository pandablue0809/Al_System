...
const ChatConstant = {
  WIP: 'Coming Soon...',
  Error: {
    Unauthorized: 'Unauthorized access, please enter access code or your own api key in [auth](/#/auth) page.',
  },
  Auth: {
  ...
  Settings: {
    ...
    AccessCode: {
      Title: 'Access Code',
      SubTitle: 'Obtain your API key or access code from the following URL: {link}',
      Placeholder: 'Paste Your Access Code or API Key',
    },
    Endpoint: {
      Title: 'Endpoint',
