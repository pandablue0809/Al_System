        ...
        <div className='relative flex justify-start ml-[8%] md:ml-[15%] md:text-[250px] md:leading-[298px] md:font-[600]'>
          <CSSTransition
            ...
            classNames={{
              ...
              enterActive: 'top-[0px] right-[350px] scale-50 transition transform duration-1000',
              enterDone: 'top-[0px] right-[50px] ds-20',
            }}>
            <div ref={nodeRefEarth} className='absolute transition-all duration-1000'>
              <Earth />
            </div>
          </CSSTransition>
          ...
          <CSSTransition
            ...
            classNames={{
              ...
              enterActive: 'md:text-[24px] md:leading-[29px] transition-transform scale-50 duration-1000',
              enterDone: 'md:text-[250px] md:leading-[280px] duration-1000',
            }}>
            <div
              ref={nodeRefSpan}
              className='text-transparent text-[52px] md:text-[24px] leading-[76px] md:leading-[29px] font-[600] md:bg-introearn-title-gradient md:bg-clip-text transition-all'>
              SOTRU
            </div>
          </CSSTransition>
        </div>
