...
import { PlusIcon } from '../../../mockData/PlusIcon';
import { VerticalDotsIcon } from '../../../mockData/VerticalDotsIcon';
import { ChevronDownIcon } from '../../../mockData/ChevronDownIcon';
import { columns, users, statusOptions } from '../../../mockData/teamData';
import { SearchIcon } from '../../../mockData/SearchIcon';
      ...
      case 'actions':
        return (
          <div className='relative flex justify-end items-center gap-2'>
            <Dropdown className='bg-[#27272A] outline-none border-none'>
              <DropdownTrigger>
    ...
    return (
      <div className='flex flex-col gap-4'>
        <div className='flex justify-between gap-3 items-end'>
          ...
          />
          <div className='flex gap-3 bg-foreground'>
            <Dropdown className='bg-[#27272A] outline-none border-none'>
            ...
            <Button className='bg-gray-300 text-background' endContent={<PlusIcon />} size='sm'>
              Add New
            </Button>
          </div>
        </div>
        <div className='flex justify-between items-center'>
          ...
          <label className='flex items-center text-default-400 text-small'>
            Rows per page:
            <select className='bg-[#27272A] outline-none border-none text-default-400 text-small' onChange={onRowsPerPageChange}>
    ...
    <div className='w-full relative mx-auto py-1 md:px-2 rounded-lg h-full box-border'>
      <div className='relative mx-auto px-5 flex items-center justify-between bg-foreground rounded-lg md:rounded-xl shadow-md mt-4 h-[95%]'>
        <Table
          ...
          checkboxesProps={{
            classNames: {
              wrapper: 'after:bg-gray-300 after:text-black text-black',
            },
          }}
