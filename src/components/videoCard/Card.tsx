...
import ImgVideoBanner from '../ImgVideoBanner';
...
const Card: React.FC<CardProps> = ({ id, className, img, video, title1, title2, description, btnTitle, url }) => {
  ...
  return (
    <div
      id={id}
      className={`w-[280px] md:w-[340px] p-[18px] md:p-[24px] bg-main-card dark:bg-main-card-dark rounded-[26px] border border-[#FFFFFF68] shadow-main-card dark:shadow-main-card-dark ${className}`}>
      ...
      <div className='mt-[12px] md:mt-[20px]'>
        <ImgVideoBanner className='' img={img} video={video} description={description} />
      </div>
        ...
        {id === 'main-card-stocks' && (
          <button
            ...
            <div className='bg-[#ffffff] dark:bg-[#32283C] rounded-[16px] text-[#000000] p-2'>
              <span className='font-semibold text-[14px] md:text-[20px] text-transparent bg-clip-text bg-gradient-to-r from-[#1199FA] to-[#00DDA2]'>
                {btnTitle}
              </span>
            </div>
          </button>
