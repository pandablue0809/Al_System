        ...
        {isSignUp && (
          <>
            <div className='mt-1 grid grid-cols-4 gap-2'>
              ...
              <div
                className={` h-1 rounded-md  ${
                  securityLevel === 'Strong' ? 'bg-green-600' : securityLevel === 'Midstrong' ? 'bg-yellow-300' : ' bg-gray-300'
                }`}></div>
              <div className={` h-1 rounded-md  ${securityLevel === 'Strong' ? 'bg-green-600' : ' bg-gray-300'}`}></div>
            </div>
